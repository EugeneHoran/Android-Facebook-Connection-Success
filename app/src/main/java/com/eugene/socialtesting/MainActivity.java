...
public class MainActivity extends ActionBarActivity {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY = "com.eugene.socialtesting:PendingAction";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FacebookSdk.sdkInitialize(this.getApplicationContext()); // Always call before any facebook implementations
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
            new FacebookCallback<LoginResult>() {
                ...
                public void onCancel() {
                    ...
                    Log.e("Login Cancel", "login Cancel");
                    updateUI();
                }
